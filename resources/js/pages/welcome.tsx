...
export default function Welcome() {
    ...
    return (
        <>
            ...
            <div className="flex min-h-screen flex-col items-center bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 p-6 text-[#1b1b18] lg:justify-center lg:p-8">
                ...
                <div className="flex w-full items-center justify-center opacity-100 transition-opacity duration-750 lg:grow starting:opacity-0">
                    <main className="flex w-full max-w-[335px] flex-col-reverse lg:max-w-4xl lg:flex-row">
                        <div className="flex-1 rounded-br-lg rounded-bl-lg bg-white/80 backdrop-blur-sm p-6 pb-12 text-[13px] leading-[20px] shadow-[inset_0px_0px_0px_1px_rgba(26,26,0,0.16)] lg:rounded-tl-lg lg:rounded-br-none lg:p-20">
                            <h1 className="mb-1 font-medium">
                                Welcome to AI-Powered Academic Management
                            </h1>
                            <p className="mb-2 text-[#706f6c] dark:text-[#A1A09A]">
                                Streamline your academic workflow with intelligent tools and automation.
                                <br />
                                Get started with our comprehensive management platform.
                            </p>
                        ...
                        <div className="relative -mb-px aspect-[335/376] w-full shrink-0 overflow-hidden rounded-t-lg bg-gradient-to-br from-pink-100 to-orange-100 lg:mb-0 lg:-ml-px lg:aspect-auto lg:w-[438px] lg:rounded-t-none lg:rounded-r-lg">
                            <svg
                            ...
                            <div className="absolute inset-0 rounded-t-lg shadow-[inset_0px_0px_0px_1px_rgba(26,26,0,0.16)] lg:rounded-t-none lg:rounded-r-lg bg-gradient-to-br from-transparent via-white/10 to-transparent" />
                        </div>
                    </main>
                </div>
